...
<template>
  <div class="flex flex-col rounded-md shadow overflow-clip bg-white dark:bg-grayscale-900">
    <div class="h-16 w-32 flex items-center justify-center" :style="{ backgroundColor: hexColor }">
      <TypographyElement
        ...
        :class="'text-xs'"
        :text-color="
          luminance(hexColor.toString()).toFixed(2) >= 0.25 ? 'text-gray-950' : 'text-gray-50'
        "
      >
    ...
    <div class="flex flex-col p-3">
      <TypographyElement variant="text-main" className="mb-1">
        {{ name }}
      </TypographyElement>
